...
```bash
pnpm add react-aria-components @radix-ui/react-slot usehooks-ts lucide-react cva@beta tailwindcss-react-aria-components react-hook-form @hookform/resolvers
```
...
- [Form Library](/docs/library/form)
- [Utils Library](/docs/library/utils)
